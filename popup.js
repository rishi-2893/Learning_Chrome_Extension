...
const addNewBookmark = (bookmarks, bookmark) => {
    ...
    // Adds img elements with play icon, onPlay is callback function and controlsElement is parent element
    ...
    // Setting timestamp as attribute so that we can start playing video from that timestamp
    // You can get value of timestamp by using newBookmarkElement.getAttribute("timestamp")
...
// Call back function is asynchronous because getActiveTabURL is async function which returns promise
// And as we want to use await instead of .then or .catch, we need to use "async" callback function
